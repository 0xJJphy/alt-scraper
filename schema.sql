...
-- 48h operational intraday history for GLI Paper Live fills/SLTP audit.
-- Kept separate from futures_snapshots so 4H research aggregates are unchanged.
...
CREATE INDEX IF NOT EXISTS idx_fis_base_at ON futures_intraday_snapshots(base_asset, snapshot_at DESC);
...
-- ==============================================================================
-- FUTURES 15M KLINES
-- Exchange-native closed 15 minute price/volume candles written by
-- realtime_daemon.py. These are authoritative exchange OHLCV bars, distinct from
-- futures_intraday_snapshots which are point-in-time metric polls.
-- ==============================================================================
